...
void init(){
   ...
   shader = SM.loadfromFile("cartoon.vert","cartoon.frag"); // load (and compile, link) from file
		  if (shader==0) 
...
void render(){
	...
	//shader->setUniform1f("powSpec", powSpec);
...
int main (int argc, char** argv) {
	...
	glutCreateWindow("Test Opengl Proyecto Shaders - Adriana Devera");
